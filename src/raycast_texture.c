...
/**
 * plot_textured_walls - Displats textured wall in the SDL window
 * @sdl: pointer to SDL_Instance data structure
 * @wallhgt: height of the wall to draw
 * @currcol: column on the screen to draw the texture
 * @strt_axis: starting cordinate of column to start drawing
